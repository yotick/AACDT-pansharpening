...
def overlap_crop_forward(ms_up, ms, pan, model, shave=8, min_size=68200, bic=None):
    """
...
def test(test_data_loader, model, sate):
    ...
    for ms_up_crop, ms_org_crop, pan_crop, _, _ in val_bar:
        ...
        with torch.no_grad():  # validation
            ...
            start = time.time()
            ### start testing ######
            out = overlap_crop_forward(ms_up, ms, pan, model, shave=5, min_size=60000, bic=None)  ## 如果需要切割。
            # out = overlap_crop_forward(ms_up, ms, pan, model, shave=4, min_size=62000,
            #                            bic=None)  # 62000, or crop 1/4 :72000, crop 1/2 :271000
...
if __name__ == "__main__":
    ...
    if opt.satellite == 'ik':
        ...
        opt.checkpoint = 'pl_epoch_300.pth'
    elif opt.satellite == 'wv3_8':
        # opt.checkpoint = 'wv3_8_epoch_300_light.pth'
        opt.checkpoint = 'wv3_8_epoch_300.pth'
